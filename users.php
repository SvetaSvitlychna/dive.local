                ...
                <ul class="navbar-nav ml-auto">
                    <?php if(empty($_SESSION)){?>
                     <li class="nav-item">
                        ...
                        <a class="nav-link" href="<?php echo "page_login.php"; ?>">Войти</a>
                    </li>
                    <?php }else{?>
                    <li class="nav-item">

                        <a class="nav-link" href="<?php echo "users.php";
                        session_destroy();
                        ?>">Выйти</a>
                    </li>
                    <?php }?>
                ...
                <div class="col-xl-4">
                   <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user['first_name']. ' '. $user['last_name'];?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('downloads/cat3.jpg'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="user_handler.php?id=<?php echo $user['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $user['job'] .', '. $user['company']?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="<?php echo $user['phone']?>" class="mt-1 d-block fs-sm fw-400 text-dark">
